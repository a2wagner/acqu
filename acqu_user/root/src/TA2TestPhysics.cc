...
#include "TA2TestPhysics.h"

ClassImp(TA2TestPhysics)

//-----------------------------------------------------------------------------

TA2TestPhysics::TA2TestPhysics(const char* Name, TA2Analysis* Analysis) : TA2BasePhysics(Name, Analysis)
{
...
void TA2TestPhysics::SetConfig(Char_t* line, Int_t key)
{
	// default SetConfig()
...
void TA2TestPhysics::LoadVariable()
{
...
void TA2TestPhysics::Reconstruct()
{
...
void TA2TestPhysics::GetParticles()
{
	nParticles = 0;
	nParticlesCB = 0;
	nParticlesTAPS = 0;
...
void TA2TestPhysics::GetTrueParticles()
{
	nParticles = 0;
	nParticlesCB = 0;
	nParticlesTAPS = 0;
...
bool TA2TestPhysics::KinematicFit()
{
...
void TA2TestPhysics::PlotData()
{
	//...
}

/* Do the analysis for all combinations possible with the detected particles */
/*bool TA2TestPhysics::ReconstructCombinatorics()
{
	return 0;
}*/

int TA2TestPhysics::GetPermutations(Int_t perm[][N_FINAL_STATE])
{
...
unsigned int TA2TestPhysics::binomial(int n, int k)
{
	unsigned int e;
	if (k > n) return 0;
	if (k == 0 || k == n) return 1;
...
void TA2TestPhysics::TermArrays()
{
	// Simulation stuff
...
void TA2TestPhysics::ParseMisc(char* line)
{
...
void TA2TestPhysics::GetTrueBeam()
{
...
void TA2TestPhysics::SetTrueParticles()
{
...
void TA2TestPhysics::PlotTrueParticles()
{
	for (Int_t i = 0; i < trueNProt; i++) {
